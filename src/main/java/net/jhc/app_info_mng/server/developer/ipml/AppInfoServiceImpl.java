...
import net.jhc.app_info_mng.dao.AppInfoMapper;
import net.jhc.app_info_mng.dao.AppVersionMapper;
import net.jhc.app_info_mng.pojo.AppInfo;
import net.jhc.app_info_mng.pojo.AppVersion;
import net.jhc.app_info_mng.server.developer.AppInfoService;
